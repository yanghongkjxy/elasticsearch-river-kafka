...
public class StatsAgent {
    ...
    public StatsAgent(RiverConfig riverConfig) {
        ...
        this.client = new NonBlockingStatsDClient(riverConfig.getStatsdPrefix(), riverConfig.getStatsdHost(),
    ...
    public void logStats(Stats stats) {
        ...
        for (Integer partitionId : stats.lastCommitOffsetByPartitionId.keySet()) {
            client.gauge(String.format("%s.partition_%s.offset", keyPrefix, partitionId),
